...
### Entities
- **CostManagementRecord**: Core domain record for Cost Management scenarios.
- **CostManagementProcess**: Process context handling lifecycle transitions.
- **CostManagementAuditEvent**: Immutable operation/audit trace entry.

### Relations
- **CostManagementRecord** 1:N **CostManagementProcess** (lifecycle orchestration).
- **CostManagementProcess** 1:N **CostManagementAuditEvent** (traceability and compliance).
