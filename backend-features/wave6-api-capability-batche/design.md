...
### Entities
- **Wave6ApiCapabilityBatcheRecord**: Core domain record for Wave6 Api Capability Batche scenarios.
- **Wave6ApiCapabilityBatcheProcess**: Process context handling lifecycle transitions.
- **Wave6ApiCapabilityBatcheAuditEvent**: Immutable operation/audit trace entry.

### Relations
- **Wave6ApiCapabilityBatcheRecord** 1:N **Wave6ApiCapabilityBatcheProcess** (lifecycle orchestration).
- **Wave6ApiCapabilityBatcheProcess** 1:N **Wave6ApiCapabilityBatcheAuditEvent** (traceability and compliance).
