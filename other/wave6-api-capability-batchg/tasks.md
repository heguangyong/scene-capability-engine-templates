...
# Implementation Plan: Wave6 API 能力增强 Batch G（16-06）
...
- [x] 2 实现标签目录 API
  - [x] 2.1 新增 `GET /api/v1/tags`
  - [x] 2.2 新增 `GET /api/v1/tags/{tag}/routes`
  - [x] 2.3 增强 `/api/v1` 导航字段（`tags`/`tagRoutesPattern`）

- [x] 3 同步 OpenAPI 与测试
  - [x] 3.1 `DocsController` 增加 tags 路径与参数说明
