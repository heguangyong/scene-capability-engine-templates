...
# Implementation Plan: Wave2 覆盖率实施 Batch A（12-04）
...
- [x] 2 补充 Wave2 Batch A 测试
  - [x] 2.1 新增 `EntityCrudService.batch` 分支测试
  - [x] 2.2 新增 `ServiceInvocationService` 主路径测试

- [x] 3 验证与覆盖率回采
  - [x] 3.1 执行新增测试定向验证
  - [x] 3.2 执行 `mvn -q -pl app -am test`
  - [x] 3.3 执行 `scripts/quality-baseline.ps1` 并记录与 12-03 增量
