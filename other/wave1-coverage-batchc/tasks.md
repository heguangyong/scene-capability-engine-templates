...
# Implementation Plan: Wave1 覆盖率实施 Batch C（12-03）
...
- [x] 2 补充 Batch C 流程测试
  - [x] 2.1 新增 `ServiceController` 工作流测试
  - [x] 2.2 新增 `EntityController` 工作流测试

- [x] 3 验证与覆盖率回采
  - [x] 3.1 执行新增测试定向验证
  - [x] 3.2 执行 `mvn -q -pl app -am test`
  - [x] 3.3 执行 `scripts/quality-baseline.ps1` 并记录与 12-02 增量
