...
### Entities
- **Wave4CoverageBatchbRecord**: Core domain record for Wave4 Coverage Batchb scenarios.
- **Wave4CoverageBatchbProcess**: Process context handling lifecycle transitions.
- **Wave4CoverageBatchbAuditEvent**: Immutable operation/audit trace entry.

### Relations
- **Wave4CoverageBatchbRecord** 1:N **Wave4CoverageBatchbProcess** (lifecycle orchestration).
- **Wave4CoverageBatchbProcess** 1:N **Wave4CoverageBatchbAuditEvent** (traceability and compliance).
